...
public class EquipmentEndpointTest implements TestData {
    ...
    public void createEquipment_withValidDto_returns200AndSavedData() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(post("/api/v1/equipment")
    ...
    public void getAllEquipment_returnsCreatedEquipment() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment")
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$").isArray())
    ...
    public void getEquipmentByType_withValidType_returnsOnlyEquipmentOfThatType() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/type/helmet")
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$").isArray())
    ...
    public void getEquipmentByType_withUnknownType_returnsNotFound() {
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/type/UNKNOWN_NONEXISTENT_TYPE")
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
    ...
    public void getEquipmentById_withValidId_returnsEquipmentDetail() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/{id}", created.getId())
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    public void getEquipmentById_withUnknownId_returnsNotFound() {
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/{id}", 99999L)
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isNotFound()));
    }
    ...
    public void getEquipmentByBarcodeId_withValidBarcode_returnsEquipmentDetail() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/barcode/{barcodeId}", created.getBarcodeId())
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    public void getEquipmentByBarcodeId_withUnknownBarcode_returnsNotFound() {
        assertDoesNotThrow(() -> mockMvc.perform(get("/api/v1/equipment/barcode/{barcodeId}", "NON-EXISTENT-BARCODE-99999")
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isNotFound()));
    }
    ...
    public void updateEquipment_withValidSkiDto_returnsOkAndUpdatedFields() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(patch("/api/v1/equipment/{id}", created.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(patchJson)
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
    ...
    public void updateEquipment_withUnknownId_returnsNotFound() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(patch("/api/v1/equipment/{id}", 99999L)
                .contentType(MediaType.APPLICATION_JSON)
                .content(patchJson)
                .header(securityProperties.getAuthHeader(), adminToken())
                .accept(MediaType.APPLICATION_JSON))
    ...
    public void deleteEquipment_withValidId_returnsNoContentAndDeletesEntity() {
        ...
        assertDoesNotThrow(() -> mockMvc.perform(delete("/api/v1/equipment/{id}", created.getId())
                .header(securityProperties.getAuthHeader(), adminToken()))
    ...
    public void deleteEquipment_withUnknownId_returnsNotFound() {
        assertDoesNotThrow(() -> mockMvc.perform(delete("/api/v1/equipment/{id}", 99999L)
                .header(securityProperties.getAuthHeader(), adminToken()))
            .andExpect(status().isNotFound()));
    }
