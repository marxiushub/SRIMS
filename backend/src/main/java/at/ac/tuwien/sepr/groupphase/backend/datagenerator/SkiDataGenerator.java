...
public class SkiDataGenerator {
    ...
    private final List<Ski> skiList = new ArrayList<>(Arrays.asList(
        ...
        new Ski("Atomic Redster X5", 35.0, 165.0, RentalStatus.FREE, SkillLevel.INTERMEDIATE),
        new Ski("Head Supershape e-Magnum", 45.0, 170.0, RentalStatus.FREE, SkillLevel.ADVANCED),
        new Ski("Rossignol Experience 76", 28.0, 158.0, RentalStatus.FREE, SkillLevel.BEGINNER),
        ...
        new Ski("K2 Disruption 78C", 36.0, 166.0, RentalStatus.FREE, SkillLevel.ADVANCED),
        ...
        new Ski("Salomon S/Force 11", 42.0, 174.0, RentalStatus.FREE, SkillLevel.ADVANCED),
        ...
        new Ski("Völkl Flair 76", 33.0, 160.0, RentalStatus.FREE, SkillLevel.BEGINNER),
        new Ski("Fischer The Curv GT 80", 44.0, 171.0, RentalStatus.FREE, SkillLevel.ADVANCED),
        new Ski("K2 Press", 25.0, 165.0, RentalStatus.FREE, SkillLevel.BEGINNER),
