...
public class HelmetDataGenerator {
    ...
    private final List<Helmet> helmets = new ArrayList<>(Arrays.asList(
        ...
        new Helmet("Atomic Savor Visor", 12.0, 56.0, RentalStatus.FREE, SkillLevel.BEGINNER),
        new Helmet("Head Rev MIPS", 10.0, 58.0, RentalStatus.FREE, SkillLevel.INTERMEDIATE),
        new Helmet("Poc Obex Pure", 11.0, 55.0, RentalStatus.FREE, SkillLevel.INTERMEDIATE),
        ...
        new Helmet("Uvex P1us 2.0", 8.0, 53.0, RentalStatus.FREE, SkillLevel.BEGINNER),
