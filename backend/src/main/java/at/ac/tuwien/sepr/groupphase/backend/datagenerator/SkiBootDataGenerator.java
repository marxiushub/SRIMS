...
public class SkiBootDataGenerator {
    ...
    private final List<SkiBoot> skiBootList = new ArrayList<>(Arrays.asList(
        ...
        new SkiBoot("Atomic Hawx Prime 80", 22.0, 265, RentalStatus.RENTED, SkillLevel.BEGINNER),
        new SkiBoot("Head Edge LYT 90", 26.0, 270, RentalStatus.FREE, SkillLevel.INTERMEDIATE),
        new SkiBoot("Rossignol Evo 70", 17.0, 255, RentalStatus.MAINTENANCE, SkillLevel.BEGINNER),
        ...
        new SkiBoot("Fischer RC One 100", 28.0, 285, RentalStatus.RENTED, SkillLevel.ADVANCED),
        ...
        new SkiBoot("Salomon S/Pro 120", 38.0, 295, RentalStatus.RENTED, SkillLevel.ADVANCED),
        ...
        new SkiBoot("Nordica Speedmachine 110", 35.0, 290, RentalStatus.MAINTENANCE, SkillLevel.ADVANCED),
        new SkiBoot("Tecnica Cochise 100", 30.0, 285, RentalStatus.FREE, SkillLevel.INTERMEDIATE),
        new SkiBoot("Fischer Ranger One 80", 24.0, 275, RentalStatus.RENTED, SkillLevel.BEGINNER),
