...
public class SnowboardBootDataGenerator {
    ...
    private final List<SnowboardBoot> snowboardBootList = new ArrayList<>(Arrays.asList(
        ...
        new SnowboardBoot("Nitro Sentinel TLS", 16.0, "TLS", RentalStatus.RENTED, SkillLevel.BEGINNER),
        new SnowboardBoot("Salomon Launch Lace", 17.0, "Laces", RentalStatus.FREE, SkillLevel.BEGINNER),
        new SnowboardBoot("Ride Anthem BOA", 21.0, "BOA", RentalStatus.MAINTENANCE, SkillLevel.INTERMEDIATE),
        ...
        new SnowboardBoot("Vans Hi-Standard OG", 22.0, "Laces", RentalStatus.RENTED, SkillLevel.INTERMEDIATE),
        ...
        new SnowboardBoot("Salomon Dialogue Dual BOA", 28.0, "Double BOA", RentalStatus.RENTED, SkillLevel.ADVANCED),
