...
describe('EquipmentCreateEditComponent', () => {
  ...
  it('should call create service, navigate back to inventory and show success notification', () => {
    component.equipment = {
      type: EquipmentType.SKI,
      model: 'Test Ski',
      status: RentalStatus.FREE,
    ...
    spyOn(translateService, 'instant').and.returnValue('Item successfully created');
  ...
  it('should call update service, navigate back to inventory in edit mode and show success notification', () => {
    component.mode = EquipmentCreateEditMode.edit;
    component.equipmentId = 123;
    component.equipment = {
      type: EquipmentType.HELMET,
    ...
    const translateService = TestBed.inject(TranslateService);
    spyOn(translateService, 'instant').and.returnValue('Item successfully updated');
