// AI-assisted: Code partially generated by Google Gemini from inventory.component.spec.ts in staff
...
describe('CustomerInventoryComponent', () => {
  ...
  beforeEach(async () => {
    equipmentServiceMock = jasmine.createSpyObj('EquipmentService', ['getAll', 'search']);
  ...
  it('should clear filters, reset sort, and reload equipment', () => {
    ...
    expect(component.equipment.map(e => e.id)).toEqual([2, 1]); // Sortiert nach 'asc' nach dem Reload (10 vor 20)
  });
  ...
  it('should build unique, sorted model options when equipment is loaded', () => {
    const loaded = [
      ...
      {...testEquipment[0], id: 3, model: 'Ski A'}, // Duplikat
